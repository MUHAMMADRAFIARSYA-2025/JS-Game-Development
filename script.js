window.addEventListener('load', function() {
    ...
    class Shield {
        ...
        draw(context) {
            // FIX: Only draw if the animation is currently running
            if (this.frameX <= this.maxFrame) {
    ...
    class Particle {
        constructor(game, x, y) {
            ...
            this.spriteSize = 50;
            // FIX: Removed toFixed(1) so it remains a number for calculation
    ...
    class Game {
        ...
        draw(context) {
            ...
            // FIX: UI is now drawn last so it is visible over enemies and particles
